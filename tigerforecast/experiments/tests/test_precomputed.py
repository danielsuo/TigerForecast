...
from tigerforecast.problems import *
from tigerforecast.methods import *
...
def test_precomputed(steps=100, show=0):
    ...
    exp.initialize(problems = [Random, ARMA], methods = [PredictZero, LastValue], timesteps=100, verbose=show)
