...
def uci_indoor(verbose=True):
    ...
    path_uci_indoor_zip = os.path.join(tigerforecast_dir, 'data/uci_indoor.zip')
    path_uci_indoor_unzip = os.path.join(tigerforecast_dir, 'data/uci_indoor')
    path_uci_indoor_txt1 = os.path.join(tigerforecast_dir, 'data/uci_indoor/NEW-DATA-1.T15.txt')
    path_uci_indoor_csv = os.path.join(tigerforecast_dir, 'data/uci_indoor.csv')
    path_uci_indoor_cleaned = os.path.join(tigerforecast_dir, 'data/uci_indoor_cleaned.csv')
...
def sp500(verbose=True):
    ...
    path_sp500_xls = os.path.join(tigerforecast_dir, 'data/sp500_xls.xls')
    path_sp500_txt = os.path.join(tigerforecast_dir, 'data/sp500_col.txt')
    path_sp500_csv = os.path.join(tigerforecast_dir, 'data/sp500.csv')
...
def crypto(verbose=True):
    ...
    """
    tigerforecast_dir = get_tigerforecast_dir()
    path_crypto_csv = os.path.join(tigerforecast_dir, 'data/crypto.csv')
...
def enso(input_signals, include_month, output_signals, history, timeline):
    ...
    tigerforecast_dir = get_tigerforecast_dir()
    datapath = os.path.join(tigerforecast_dir, 'data/enso.csv')
...
def dataset_to_problem(file, X_cols = None, y_cols = None, T = 1):
    ...
    if(type(file) is str):
        tigerforecast_dir = get_tigerforecast_dir()
        datapath = os.path.join(tigerforecast_dir, file)
